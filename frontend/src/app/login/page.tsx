    ...
    <div className="min-h-screen bg-white text-black flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-black tracking-tighter uppercase italic text-black">BIENVENIDO A <span className="text-yellow-500">AAUCA</span></h1>
          <p className="text-gray-500 mt-2 font-bold uppercase text-[10px] tracking-[0.3em]">Accede a tu cuenta académica oficial</p>
        </div>

        <div className="glass-card-aauca p-10 rounded-[3rem] border border-black/5 bg-gray-50/50 backdrop-blur-2xl shadow-2xl">
          <button 
            onClick={handleGoogleLogin}
            className="w-full py-4 px-6 rounded-2xl bg-white text-black font-black flex items-center justify-center gap-4 hover:bg-gray-100 border border-black/5 transition-all mb-8 shadow-xl"
          >
